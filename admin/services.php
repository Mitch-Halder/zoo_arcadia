<?php
    ...
    ?>
        <a href="services.php?action=create">
    ...
    <div class="card">
        ...
        <div>
        <a href="services.php?action=delete&id=<?php echo htmlspecialchars($oneServices['_id']);?>">

            <button class="btn-red-sm">supprimer</button></a>

            <a href="services.php?action=update&id=<?php echo htmlspecialchars($oneServices['_id']);?>">
